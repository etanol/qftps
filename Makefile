...
help:
	...
	@echo '	splice - Linux (2.6.17 and above) version which uses the'
	@echo '	         new splice() system call.  Requires glibc 2.5 or'
	@echo '	         higher.  This implementation is currently broken,'
	@echo '	         use it only if you are interested in development.'
